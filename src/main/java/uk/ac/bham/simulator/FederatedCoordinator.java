 ...
 * number of bids can be altered in AgentManager Class line 27
 * number of asks can be altered in ServiceProviderManager line 216 (new AskCreator, second parameter is a number of asks to be created)
 * the intensity of adverse conditions can be tweaked in this class at lines 349 and 363
 * to test flat security compared to ours, use Auction class line 353
 */
public class FederatedCoordinator implements Runnable {
    ...
    // Testing: Flat Security level, 1:low-3 High
    static int providedSecurityLevel =3;
    ...
    public synchronized void run() {
        ...
        // TESTING: PRINT THE INSUFFICIENT AND EXCESIVE SECURITY LEVEL
      //  System.out.println("Insufficient Security Level="+Agent.insufficientSecurityLevel);
     //   System.out.println("Excesive Security Level="+Agent.excesiveSecurityLevel);
    }
    ...
    //	long startTime = System.nanoTime(); //to test how much time the system requires to run
       ...
       System.out.println("Adverse Conditions: Do you want to run the simulation under the influence of malicious service providers? - Please state your answer with 'yes' or 'no' ");
        ...
        if (input.toLowerCase().equals("yes")) {
            ...
            SPpercentage = 50;//used by the serviceProviderManager (line 94) to flag this percentage of SPs as malicious and remove them from the market
        ...
        if (input2.toLowerCase().equals("yes")) {
            Resourcepercentage = 80; //used by the serviceProviderManager (line 172) to flag this percentage of resources as faulty and remove them from the market (due to physical, VM errors and denial attacks)
    ...
    //	System.out.println("Took "+ (double) (endTime - startTime) /1000000000 + " sec");
    }
