...
public class Utilities 
{
    ...
    public static void prepareParam(ArrayList<ArrayList<String>> model, ConcurrentHashMap<String, Integer> param)
    {
        ...
        for(int i=0; i<maxColumnLength.size(); i++)
        {
            ...
            if(i>0) totalLength+=maxColumnLength.get(i);
    ...
    public static String[] getExtraData(IdentityResource.ResourceType feature, AuctionAsk ask)
    {
        ...
        String[] assetList={"University ID", "Company ID", "Identity Information"};
       ...
       // else smemory=(memory/1024.0)+" Gbyte";
        ...
        {
            String[] services={"Anonymity proxy", "Usage of Psuedonyms"};
        ...
        {
            String[] services={"Raid2-data backup", "Mirrored VMs in different physical servers"};
        ...
        {
            String[] services={"Massage authentication code (MAC)", "Identity aware fraud detection"};
        ...
        {
            String[] services={"Encryption at transit with keys concealed from cloud sp", "Permanent Deletion of identity related information"};
        ...
        extraData[DAT_SERVICE]=serviceNameList[iservice];
